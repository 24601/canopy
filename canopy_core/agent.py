...
class MassAgent(ABC):
        ...
        add_span_attributes(
            {
                ...
                "tools.count": len(tools) if tools else 0,
            }
        )
    ...
    def _get_system_tools(self) -> List[Dict[str, Any]]:
        ...
        available_options = [
            agent_id for agent_id, agent_state in self.orchestrator.agent_states.items() if agent_state.curr_answer
        ]
