...
def run_mass_with_config(question: str, config: MassConfig) -> Dict[str, Any]:
    ...
    orchestrator = MassOrchestrator(
        ...
        algorithm_profile=config.orchestrator.algorithm_profile,
        algorithm_config=config.orchestrator.algorithm_config,
    )

    # Set log manager
    orchestrator.log_manager = log_manager

    # Update streaming display with algorithm name
    if streaming_orchestrator:
        streaming_orchestrator.update_algorithm_name(config.orchestrator.algorithm)
